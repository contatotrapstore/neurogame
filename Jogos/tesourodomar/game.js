...
const assetsToLoad = [
    ...
    { name: 'player', url: 'assets/peixenovo2.gltf?3' },
...
function iniciarFase(){
	...
	musica = new Audio('assets/musicatesouro.mp3');
...
function updatePlayerMovement() {
	...
	if(direita){ playerBalloon.position.z += 0.08; playerBalloon.rotation.y += (playerBalloon.rotation.y < 0.5 && playerBalloon.position.z < 5) ? 0.05 : 0; }
	else if(esquerda){ playerBalloon.position.z -= 0.08; playerBalloon.rotation.y -= (playerBalloon.rotation.y > -0.5 & playerBalloon.position.z > -6) ? 0.05 : 0; }
